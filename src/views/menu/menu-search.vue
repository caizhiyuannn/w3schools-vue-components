  ...
  computed: {
    menuLists: function() {
      return this.menus.filter(v =>
        v.name.toLowerCase().includes(this.searchText.toLowerCase().trim())
      );
    }
  }
};
